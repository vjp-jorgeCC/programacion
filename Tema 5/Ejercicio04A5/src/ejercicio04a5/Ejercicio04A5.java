...
public class Ejercicio04A5 {
    ...
    //Calcula el coste del plato y lo retorna.
    public static float calcularCoste(Plato P1, Plato P2, Plato P3, int opc, int numRaciones){
        float coste = 0;
        int raciones;
        switch(opc){
            case 1:
                coste = P1.getCoste() * numRaciones;
                break;
            case 2:
                coste = P2.getCoste() * numRaciones;
                break;
            case 3:
                coste = P3.getCoste() * numRaciones;
                break;
        }
        return coste;
    }
    ...
    public static void main(String[] args) {
        ...
        Plato P1 = new Plato("Nachos", 8, 35, 3);
        Plato P2 = new Plato("Burritos", 12, 10, 8);
        Plato P3 = new Plato("Tacos", 10, 20, 5);
        ...
        do{
            ...
            if  (stockOk){
                ...
                costeTotal = costeTotal + calcularCoste(P1, P2, P3, opc, numRaciones);
            }
            resp = pedirRespuesta();
        }while(resp.equalsIgnoreCase("SI"));
        System.out.println("La cuenta asciende a "+precioTotal+" Euros. (Beneficio Neto: "+(precioTotal - costeTotal)+" Euros)");
